...
def test_steps_5() -> None:
    ...
    AnalyzerTestWrapper(
        ...
        error_msg="Cannot override attack step 'spyware' previously defined at 6 with different type '|' =/= '&"
    )
...
def test_steps_7() -> None:
    ...
    AnalyzerTestWrapper(
        ...
        error_msg="Cannot override attack step 'compromiseCamera' previously defined at 6 with different type '!E' =/= 'E'"
    )
...
def test_steps_8() -> None:
    ...
    AnalyzerTestWrapper(
        ...
        error_msg="Cannot override attack step 'noCamera' previously defined at 6 with different type 'E' =/= '!E'"
    )
...
def test_steps_10() -> None:
    ...
    AnalyzerTestWrapper(
        ...
        error_msg="Cannot override attack step 'compromise' previously defined at 5 with different type '&' =/= '|'"
    )
...
def test_steps_13() -> None:
    ...
    AnalyzerTestWrapper(
        ...
        error_msg="Cannot override attack step 'compromise' previously defined at 2 with different type '&' =/= '|'"
    )
