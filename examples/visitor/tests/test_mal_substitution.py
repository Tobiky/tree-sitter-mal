...
def test_substitution_2() -> None:
    ...
    AnalyzerTestWrapper(
        ...
        error_msg="Variable 'hostsOperatingSystems' is not defined\n" + \
                  "Line 9: All expressions in reaches ('->') must point to a valid attack step"
    )
...
def test_substitution_6() -> None:
    ...
    AnalyzerTestWrapper(
        ...
        error_msg="Variable 'hostsOperatingSystems' is not defined\n" + \
                  "Line 5: All expressions in reaches ('->') must point to a valid attack step"
    )
...
def test_substitution_7() -> None:
    ...
    AnalyzerTestWrapper(
        ...
        error_msg="Variable 'physicalComponents' is not defined\n" + \
                  "Line 14: All expressions in reaches ('->') must point to a valid attack step"
    )
