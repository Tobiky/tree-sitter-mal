...
def test_let_2() -> None:
    ...
    AnalyzerTestWrapper(
        ...
        error_msg = 'Variable \'component\' previously defined at line 8'
    )
...
def test_let_3() -> None:
    ...
    AnalyzerTestWrapper(
        ...
        error_msg="Variable 'component' defined at 5 does not point to an asset"
    )
...
def test_let_5() -> None:
    ...
    AnalyzerTestWrapper(
        ...
        error_msg = 'Variable \'component\' previously defined at 5'
    )
